...
(function () {
    ...
    Bizweb.StoreCheckout = function () {
                ...
                if (this.show_country) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            var html = "<option value=''>--- Chá»n tá»‰nh thĂ nh ---</option>";
            ...
            if (!this.otherAddress) {
                ...
                if (this.show_district) {
                    ...
                    $.ajax({
                        url: url,
                        success: function (data) {
                            var html = "<option value=''>--- Chá»n quáº­n huyá»‡n ---</option>";
        ...
        StoreCheckout.prototype.getLatLong = function (address, callback) {
            ...
            address = address || '266 Äá»™i Cáº¥n, Ba ÄĂ¬nh, HĂ  Ná»™i';
        ...
        StoreCheckout.prototype.returnCheckout = function () {
            ...
            if (prvdId == 2) {
                if (!$("#onepay_visa_confirm").is(":checked")) {
                    alert("Báº¡n chÆ°a Ä‘á»“ng Ă½ vá»›i cĂ¡c Ä‘iá»u khoáº£n vĂ  dá»‹ch vá»¥ cá»§a Onepay!");
                            ...
                            if (data.error) {
                                if (!!data.error_message) {
                                    switch (data.error_code) {
                                        case 2:
                                            handleCustomPaymentMessage("Háº¡n má»©c thanh toĂ¡n tá»‘i Ä‘a lĂ  20,000,000Ä‘ <br/ > Vui lĂ²ng chá»n hĂ¬nh thá»©c thanh toĂ¡n khĂ¡c");
                                            break;
                                        case 3:
                                            $(".invalid_order span").text("1000Ä‘");
                                            $(".trigger-qr-error-modal").trigger("click");
                                            break;
                                        case 4:
                                            handleCustomPaymentMessage("PhÆ°Æ¡ng thá»©c thanh toĂ¡n chá»‰ há»— trá»£ VND <br/ > Vui lĂ²ng chá»n hĂ¬nh thá»©c thanh toĂ¡n khĂ¡c");
                                            break;
                                        default:
                                            $("#qr-error-modal .invalid_order").hide();

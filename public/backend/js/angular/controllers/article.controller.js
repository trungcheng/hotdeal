(function($, app) {
    ...
    function ArticleController($rootScope, $scope, $http, $window, $timeout, PagerService) {
        ...
        $scope.process = function(type) {
            ...
            formData.append('vi_intro', CKEDITOR.instances.vi_short_content.document.getBody().getHtml());
            formData.append('intro', CKEDITOR.instances.short_content.document.getBody().getHtml());
            formData.append('vi_fulltext', CKEDITOR.instances.vi_full_content.document.getBody().getHtml());

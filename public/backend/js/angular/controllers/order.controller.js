(function($, app) {
    ...
    function OrderController($rootScope, $scope, $http, $window, $timeout) {
        ...
        $scope.getResultsPage = function (name, perPage, pageNumber) {
            ...
            $http.get(app.vars.baseUrl + '/orders/getAllOrders?name=' + name + '&perPage=' + perPage + '&page=' + pageNumber, {cache: false})

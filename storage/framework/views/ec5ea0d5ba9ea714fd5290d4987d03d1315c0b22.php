            ...
            <div id="owl-demo" class="owl-carousel">
                ...
                <div class="item">
                    <?php if($slide->target_type == 'product'): ?>
                        <a title="<?php echo e($slide->title); ?>" href="<?php echo e(($slide->product) ? route('product-detail', ['slug' => $slide->product->slug]) : 'javascript:void(0)'); ?>" target="_self"><img src="<?php echo e($slide->image); ?>" width="533" height="362" alt="<?php echo e($slide->title); ?>" /></a>
                    <?php else: ?>
                        <a title="<?php echo e($slide->title); ?>" href="<?php echo e(($slide->article) ? route('article-detail', ['slug' => $slide->article->slug]) : 'javascript:void(0)'); ?>" target="_self"><img src="<?php echo e($slide->image); ?>" width="533" height="362" alt="<?php echo e($slide->title); ?>" /></a>
                    <?php endif; ?>
                    <div class="slide-text" style="display:none;">
                        <div class="slide-text-header"><?php echo e($slide->title); ?></div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="body-video">
                        <div id="myElement">
                            <iframe width="100%" height="280" src="<?php echo e($setting->youtube_url); ?>" frameborder="0" allowfullscreen></iframe>
                        </div>
                        <ul id="list_player">
                            <li>
                                <a href="javascript:void(0)" class="videoItems" title="Sự diệu kỳ của tạo hóa Wildferns New Zealand" name="<?php echo e($setting->youtube_url); ?>">Sự diệu kỳ của tạo hóa Wildferns New Zealand</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="full-width box-hone gtsanpham">
        <div class="container-site">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <img alt="" src="<?php echo e(asset('backend/uploads/images/sp1.jpg')); ?>" style="width: 1600px; height: 1113px;" />
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="text-tit">
        ...
        <div class="container-site">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <a class="lienhevoichungtoi" href="<?php echo e(route('contact')); ?>" title="Liên hệ với chúng tôi">Liên hệ với chúng tôi
                    </a>
                </div>
            </div>
        </div>
                                ...
                                <li class="item-list">
                                    <div class="img-view">
                                        <a title="<?php echo e($article->title); ?>" href="<?php echo e(route('article-detail', ['slug' => $article->slug])); ?>">
                                            <img style="width:100% !important;height:100% !important;object-fit:cover;" src="<?php echo e($article->image); ?>" alt="<?php echo e($article->title); ?>" />
                                        </a>
                                    </div>
            ...
            <div class="row">
                    ...
                    <div class="itemtaisaochon">
                        <div class="khunganh">
                            <div class="khungAnhCrop" href="" title="Chất lượng tuyệt vời">
                                <img alt="Chất lượng tuyệt vời" class="tall" src="<?php echo e(asset('frontend/images/icons/icon-why1.png')); ?>" style="width: 69px; height: 69px;" />
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="itemtaisaochon">
                        <div class="khunganh">
                            <div class="khungAnhCrop" href="" title="Chất lượng tuyệt vời">
                                <img alt="Chất lượng tuyệt vời" class="tall" src="<?php echo e(asset('frontend/images/icons/icon-why2.png')); ?>" style="width: 69px; height: 69px;" />
                            </div>
                        </div>
                        <div class="noidung_taisaochon">
                            <div class="title_taisaochon" href="" title="Chất lượng tuyệt vời">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="itemtaisaochon">
                        <div class="khunganh">
                            <div class="khungAnhCrop" href="" title="Chất lượng tuyệt vời">
                                <img alt="Chất lượng tuyệt vời" class="tall" src="<?php echo e(asset('frontend/images/icons/icon-why3.png')); ?>" style="width: 69px; height: 69px;" />
                            </div>
                        </div>
                        <div class="noidung_taisaochon">
                            <div class="title_taisaochon" href="" title="Chất lượng tuyệt vời">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="itemtaisaochon">
                        <div class="khunganh">
                            <div class="khungAnhCrop" href="" title="Chất lượng tuyệt vời">
                                <img alt="Chất lượng tuyệt vời" class="tall" src="<?php echo e(asset('frontend/images/icons/icon-why1.png')); ?>" style="width: 69px; height: 69px;" /></div>
                        </div>
                        <div class="noidung_taisaochon">
                            <div class="title_taisaochon" href="" title="Chất lượng tuyệt vời">

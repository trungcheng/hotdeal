...
<head>
    ...
    <link href="<?php echo e(asset('frontend/css/nprogress.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('frontend/css/font-awesome.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('frontend/css/select2.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('frontend/css/checkout.css')); ?>" rel="stylesheet" type="text/css" />
    <script>
        var Bizweb = Bizweb || {};
...
<body class="body--custom-background-color ">
    ...
    <form method="post" action="" data-toggle="validator" class="content stateful-form formCheckout">
        <div class="wrap" context="checkout" define='{checkout: new Bizweb.StoreCheckout(this,{ token: "0f15394c112542c79b8eb0caee02058a", email: "", totalOrderItemPrice: 20900000.0000, shippingFee: 0, freeShipping: false, requiresShipping: true, existCode: false, code: "", discount: 0, settingLanguage: "vi", moneyFormat: "<?php echo e(0); ?>₫", discountLabel: "Miễn phí", districtPolicy: "optional", wardPolicy: "hidden", district: "", ward: "", province:"", otherAddress: false, shippingId: 0, shippingMethods: [], customerAddressId: 0, reductionCode: "" })}'>
            <div class='sidebar '>
                ...
                <div class="sidebar__content">
                    ...
                    <div class="order-summary order-summary--discount">
                        <div class="summary-section">
                            ...
                            <div bind-class="{'warning' : existCode && !freeShipping && discount == 0,'success' : existCode && ( freeShipping || discount >0 )}" class="clearfix hide" bind-show="code!= null && code.length && existCode && applyWithPromotion">
                                ...
                                <div bind="(discountShipping && freeShipping) ? 'Miễn phí' : money(discount,'<?php echo e(0); ?>₫')" class="pull-right">
                    ...
                    <div class="order-summary order-summary--total-lines">
                        <div class="summary-section border-top-none--mobile">
                            <div class="total-line total-line-subtotal clearfix">
                                ...
                                <span bind="money(totalOrderItemPrice - discount,'<?php echo e(0); ?>₫')" class="total-line-subprice pull-right">
                                    20.900.000₫
                                </span>
                            </div>
                            <div class="total-line total-line-shipping clearfix" bind-show="requiresShipping">
                                ...
                                <span bind="shippingFee >  0 ? money(shippingFee,'<?php echo e(0); ?>₫') : ((requiresShipping && shippingMethods.length == 0) ? 'Khu vực này không hỗ trợ vận chuyển': 'Miễn phí')" class="total-line-shipping pull-right" bind-show="ShippingProvinceId || BillingProvinceId && !otherAddress || (requiresShipping && shippingMethods.length > 0)">
                            ...
                            <div class="total-line total-line-total clearfix">
                                ...
                                <span bind="money(totalOrderItemPrice + (isNaN(shippingFee) ? 0 : shippingFee) - discount,'<?php echo e(0); ?>₫')" class="total-line-price pull-right">
                                    20.900.000₫
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="form-group clearfix hidden-sm hidden-xs">
                        <div class="field__input-btn-wrapper mt10">
                            <a class="previous-link" href="<?php echo e(route('cart')); ?>">
    ...
    <script src="<?php echo e(asset('frontend/js/twine.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('frontend/js/validator.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('frontend/js/nprogress.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('frontend/js/money-helper.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('frontend/js/select2-full.min.js')); ?>" type="text/javascript"></script>

    <script src="<?php echo e(asset('frontend/js/ua-parser.pack.js')); ?>" type='text/javascript'></script>
    <script src="<?php echo e(asset('frontend/js/checkout.js')); ?>" type="text/javascript"></script>

<?php $__env->startSection('page'); ?>Quản lý đánh giá
...
<?php $__env->startSection('content'); ?>
    <div ng-controller="ReviewController" ng-init="loadInit()">
        ...
        <section class="content-header" style="padding-top:30px;">
            <h1>
                ...
                <a href="<?php echo e(route('review-create')); ?>" class="pull-right btn btn-success btn-sm">Thêm đánh giá</a>
            </h1>
        </section>
                            ...
                            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="row" style="margin-bottom:10px;">
                                    ...
                                    <div class="col-sm-6">
                                        <div id="example1_filter" class="dataTables_filter" style="float:right;">
                                            <label>Search:
                                                <input my-enter="searchReviewName()" ng-model="searchText" type="search" class="form-control input-sm" placeholder="Tìm kiếm...">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="overflow-x:auto;">
                                        <table id="example1" class="table table-bordered table-hover table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody ng-cloak>
                                                <tr role="row" class="{{ ($odd) ? 'odd' : 'even' }}" ng-repeat="review in items track by $index">
                                                    ...
                                                    <td>
                                                        <a href="/admin/access/reviews/edit/{{ review.id }}" style="margin-right:5px;" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                                        <a ng-click="delete(review, $index)" style="margin-left:5px;" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <div ng-cloak ng-if="loading">
                                            <img src="<?php echo e(asset('backend/img/ajax_loader.gif')); ?>" style="width:3%;margin-left:46%;margin-top:0%">
                                        </div>
                                        <div ng-cloak ng-if="!loading && items.length === 0">
                                            <h5 style="font-size:16px;color:#f00;">Oops! Không tìm thấy đánh giá!</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" ng-cloak ng-if="!loading && items.length > 0">
                                    <div class="col-sm-5" style="padding-top:5px;">
                                        <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">Hiển thị từ <strong>{{ from }}</strong> đến <strong>{{ to }}</strong> của <strong>{{ total }}</strong> đánh giá</div>
                                    </div>
                                    <div class="col-sm-7">

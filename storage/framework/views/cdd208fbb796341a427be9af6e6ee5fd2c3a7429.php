        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    <h3 class="profile-username text-center"><?php echo e(($authAdminUser->full_name) ? $authAdminUser->full_name : $authAdminUser->username); ?></h3>
                    ...
                    <div class="tab-pane active" id="setting">
                        <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(route('profile')); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input value="<?php echo e($user->full_name); ?>" type="text" name="full_name" class="form-control" placeholder="Họ tên">
                                </div>
                            </div>
                            <div class="form-group">

<?php $__env->startSection('page'); ?>Đặt hàng thành công
...
<div class="full-width" style="margin-bottom:50px">
  ...
  <div class="container">
    ...
    <div class="order-success"> <i class="fa fa-check"></i>
      <h6>Đặt hàng thành công! Đơn hàng <?php echo e($order_id); ?> của quý khách đã được xử lý</h6>
      <p>Chúng tôi đã gửi thông báo đơn hàng về email của quý khách, cảm ơn quý khách đã mua hàng tại <b>Thủy Mộc Trà!</b></p>
      <p style="margin-top:10px">Nếu có bất kỳ thắc mắc gì, hãy gọi cho chúng tôi theo hotline <b><?php echo $setting->phone; ?></b></p>
      <a href="<?php echo e(route('home')); ?>" class="btn-round">Quay lại cửa hàng</a>
    </div>
  </div>
</div>
<?php $__env->stopSection(); ?>

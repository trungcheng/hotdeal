            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form id="form_setting" onsubmit="return false;" action="<?php echo e(url('/admin/access/setting/update')); ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo e($setting->logo); ?>" name="logo" type="text" size="48" class="form-control" id="xFilePath" placeholder="Logo công ty..." />
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="seo_content"><?php echo $setting->seo_content; ?></textarea>
                    </div>

                    <div class="form-group">
                        <label>SEO Schema</label>
                        <textarea class="form-control" id="seo_schema"><?php echo $setting->seo_schema; ?></textarea>
                    </div>

<?php $__env->startSection('page'); ?>Quản lý thành viên
    ...
    <div ng-controller="MemberController" ng-init="loadInit()">
        ...
        <section class="content-header" style="padding-top:30px;">
            <h1>
                ...
                <a href="<?php echo e(route('member-create')); ?>" class="pull-right btn btn-success btn-sm">Thêm thành viên</a>
            </h1>
        </section>
...
<?php $__env->startSection('pageJs'); ?>
    <?php echo Html::script('backend/js/angular/controllers/member.controller.js'); ?>

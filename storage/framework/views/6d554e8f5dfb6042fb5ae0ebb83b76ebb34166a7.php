<?php $__env->startSection('page'); ?>Khách hàng mới / đăng nhập
<?php $__env->stopSection(); ?>

<?php $__env->startSection('description'); ?>Khách hàng mới / đăng nhập
<?php $__env->stopSection(); ?>

<?php $__env->startSection('keywords'); ?>Khách hàng mới, đăng nhập
<?php $__env->stopSection(); ?>

<?php $__env->startSection('canonical'); ?><?php echo e(route('step1')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('alternate'); ?><?php echo e(route('step1')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('propName'); ?>Khách hàng mới / đăng nhập
<?php $__env->stopSection(); ?>

<?php $__env->startSection('propDesc'); ?>Khách hàng mới, đăng nhập
<?php $__env->stopSection(); ?>

<?php $__env->startSection('ogTitle'); ?>Khách hàng mới / đăng nhập
<?php $__env->stopSection(); ?>

<?php $__env->startSection('ogDesc'); ?>Khách hàng mới, đăng nhập
<?php $__env->stopSection(); ?>

<?php $__env->startSection('ogUrl'); ?><?php echo e(route('step1')); ?>
...
<?php $__env->startSection('pageJs'); ?>
	<script type="text/javascript">
		...
		$('#login_popup_form').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route("ajax-signin")); ?>',
                type: 'POST',
                processData: false,
                contentType: false,
                cache: false,
                ...
                success: function (response) {
                    if (!response.status) {
                    	...
                    	window.location.href = "<?php echo e(route('step2')); ?>";
                    }
                }
            });
		});
		...
		$('#register_popup_form').on('submit', function (e) {
            ...
            var formData = new FormData($(this)[0]);
            $.ajax({
                url: '<?php echo e(route("ajax-signup")); ?>',
                type: 'POST',
                processData: false,
                contentType: false,
                cache: false,

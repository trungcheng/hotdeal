  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a style="margin-left:20px;" data-route="/admin/access/page/policy" href="<?php echo e(url('/admin/access/page/policy')); ?>">Chính sách chung</a></li>
            <li><a style="margin-left:20px;" data-route="/admin/access/page/recruitment" href="<?php echo e(url('/admin/access/page/recruitment')); ?>">TT tuyển dụng</a></li>
            <li><a style="margin-left:20px;" data-route="/admin/access/page/saleoff" href="<?php echo e(url('/admin/access/page/saleoff')); ?>">CT khuyến mãi</a></li>
        </ul>
    </li>

<?php $__env->startSection('page'); ?>Quản lý slide
...
<?php $__env->startSection('content'); ?>
    <div ng-controller="SlideController" ng-init="loadInit()">
        ...
        <section class="content-header" style="padding-top:30px;">
            <h1>
                ...
                <a href="<?php echo e(route('slide-create')); ?>" class="pull-right btn btn-success btn-sm">Thêm slide</a>
            </h1>
        </section>
                                ...
                                <div class="row" style="margin-bottom:10px;">
                                    ...
                                    <div class="col-sm-6">
                                        <div id="example1_filter" class="dataTables_filter" style="float:right;">
                                            <label>Search:
                                                <input my-enter="searchSlideName()" ng-model="searchText" type="search" class="form-control input-sm" placeholder="Tìm kiếm...">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="overflow-x:auto;">
                                        <table id="example1" class="table table-bordered table-hover table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody ng-cloak>
                                                <tr role="row" class="{{ ($odd) ? 'odd' : 'even' }}" ng-repeat="slide in items track by $index">
                                                    <td class="sorting_1">{{ $index + 1 }}</td>
                                                    <td style="text-align:center !important">
                                                        <img ng-src="{{ slide.image }}" style="width:70px;">
                                                    </td>

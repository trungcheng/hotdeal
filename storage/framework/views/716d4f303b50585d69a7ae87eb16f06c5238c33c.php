<?php $__env->startSection('page'); ?>Quản lý sản phẩm
    ...
    <div ng-controller="ProductController" ng-init="loadInit()">
        ...
        <section class="content-header" style="padding-top:30px;">
            <h1>
                ...
                <a href="<?php echo e(route('product-create')); ?>" class="pull-right btn btn-success btn-sm">Thêm sản phẩm</a>
            </h1>
        </section>
                            ...
                            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="overflow-x:auto;">
                                        <table id="example1" class="table table-bordered table-hover table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody ng-cloak>
                                                <tr role="row" class="{{ ($odd) ? 'odd' : 'even' }}" ng-repeat="pro in items track by $index">
                                ...
                                <div class="row" ng-cloak ng-if="!loading && items.length > 0">
                                    <div class="col-sm-5" style="padding-top:5px;">
                                        <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">Hiển thị từ <strong>{{ from }}</strong> đến <strong>{{ to }}</strong> của <strong>{{ total }}</strong> sản phẩm</div>
                                    </div>
                                    <div class="col-sm-7">

<?php $__env->startSection('page'); ?>Cập nhật slide
                    ...
                    <div class="box-body">
                        <form id="formProcess" onsubmit="return false;" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                <input type="hidden" id="id" name="id" value="<?php echo e($slide->id); ?>">
                                <div class="form-group">
                                    <label>Tiêu đề</label>
                                    <input value="<?php echo e($slide->title); ?>" name="title" type="text" class="form-control title" placeholder="Tiêu đề...">
                                </div>
                                <div class="form-group">
                                    <label>Ảnh</label>
                                    <input value="<?php echo e($slide->image); ?>" name="image" type="text" size="48" class="form-control" id="xFilePath" />
                                ...
                                <div class="form-group">
                                	...
                                	<select id="target_type" name="target_type" class="form-control">
                                		<option <?php echo e(($slide->target_type == 'product') ? 'selected' : ''); ?> value="product">Sản phẩm</option>
                                		<option <?php echo e(($slide->target_type == 'article') ? 'selected' : ''); ?> value="article">Bài viết</option>
                                	</select>
                                </div>
                                <div class="form-group">
                                	...
                                	<select id="target" name="target" class="form-control">
                                		<?php if(count($results) > 0): ?>
	                                		<?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                			<option <?php echo e(($slide->target == $obj->id) ? 'selected' : ''); ?> value="<?php echo e($obj->id); ?>"><?php echo e($obj->name); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        <option <?php echo e(($slide->type == 'slide') ? 'selected' : ''); ?> value="slide">Slide</option>
                                        <option <?php echo e(($slide->type == 'ads') ? 'selected' : ''); ?> value="ads">Quảng cáo</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                	<label>Hiển thị</label>
                                	<select name="status" class="form-control">
                                		<option <?php echo e(($slide->status == 1) ? 'selected' : ''); ?> value="1">Có</option>
                                        <option <?php echo e(($slide->status == 0) ? 'selected' : ''); ?> value="0">Không</option>
                                	</select>
                                </div>
                            </div>

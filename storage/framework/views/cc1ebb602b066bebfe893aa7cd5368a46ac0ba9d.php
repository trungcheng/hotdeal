<?php $__env->startSection('page'); ?>Giỏ hàng - King Bếp
...
<?php $__env->startSection('robots'); ?>noodp,noindex,nofollow
<?php $__env->stopSection(); ?>
                                                        ...
                                                        <div class="row shopping-cart-item">
                                                            ...
                                                            <div class="col-right col-xs-9">
                                                                <div class="box-info-product">
                                                                    <p class="name">
                                                                        <a href="<?php echo e(route('product-detail', ['cate' => $item->options->cateRoot->slug, 'slug' => $item->options->slug])); ?>" target="_blank">
                                    ...
                                    <div class="cart_page_mobile content-product-list">
                                        ...
                                        <div class="item-product item productid-1">
                                            <div class="item-product-cart-mobile">
                                                <a class="product-images1" href="<?php echo e(route('product-detail', ['cate' => $item->options->cateRoot->slug, 'slug' => $item->options->slug])); ?>" title="<?php echo e($item->name); ?>">
                                                    <img width="80" height="150" alt="<?php echo e($item->name); ?>" src="<?php echo e($item->options->image); ?>">
                                                </a>
                                            </div>
                                            <div class="title-product-cart-mobile">
                                                <h3><a href="<?php echo e(route('product-detail', ['cate' => $item->options->cateRoot->slug, 'slug' => $item->options->slug])); ?>" title="<?php echo e($item->name); ?>"><?php echo e($item->name); ?></a></h3>

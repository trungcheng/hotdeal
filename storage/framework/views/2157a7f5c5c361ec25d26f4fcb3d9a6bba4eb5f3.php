<?php $__env->startSection('page'); ?>Quản lý đơn hàng
    ...
    <div ng-controller="OrderController" ng-init="loadInit()">
        ...
        <section class="content-header" style="padding-top:30px;">
            <h1>
                ...
                <!-- <a href="<?php echo e(route('order-create')); ?>" class="pull-right btn btn-success btn-sm">Thêm đơn hàng</a> -->
            </h1>
        </section>
...
<?php $__env->startSection('pageJs'); ?>
    <?php echo Html::script('backend/js/angular/controllers/order.controller.js'); ?>

            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-5 col-100-h">
                    <a href="/" class="logo-wrapper">
                        <img src="<?php echo e(asset('frontend/images/logos/logo.png')); ?>" alt="logo Ant Kitchen" />
                    </a>
                </div>
                ...
                <div class="col-md-9 no-padding">
                    <ul id="nav" class="nav">
                        ...
                        <li class="nav-item  has-mega">
                            <a href="<?php echo e(route('store')); ?>" class="nav-link">Sản phẩm <i class="fa fa-angle-right" data-toggle="dropdown"></i></a>

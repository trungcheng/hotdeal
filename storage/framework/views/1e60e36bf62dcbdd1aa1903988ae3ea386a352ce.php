<nav id="mp-menu" class="mp-menu">
    <div class="mp-level">
        ...
        <ul>
            ...
            <li><a class="icon" href="<?php echo e(route('about')); ?>">Giới thiệu</a></li>
    ...
    <header id="view_top_banner">
        <div class="row">
            <div class="container">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 hidden-sm hidden-xs" style="padding:0">
                    <div class="hotline">
                        <a class="call-view-top" href="tel:<?php echo e(str_replace(' ', '', $setting->phone)); ?>" title="Gọi ngay">
            ...
            <div class="container">
                <div class="nav-main">
                    <ul id="nav-main-menu" class="nav-menu">
                        ...
                        <li><a href="<?php echo e(route('about')); ?>" data-route="/gioi-thieu"><span class="span-menu"></span>Giới thiệu</a></li>

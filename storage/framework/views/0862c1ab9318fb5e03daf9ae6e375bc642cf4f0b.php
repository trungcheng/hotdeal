...
<html>
<head>
	<title>Xác nhận đơn hàng #<?php echo e($order->id); ?> | Thuymoctra.com.vn</title>
	<meta charset="utf-8" />
</head>
<body>
	<h1 style="font-size:17px;font-weight:bold;">Cảm ơn quý khách <b><?php echo e($name); ?></b> đã đặt hàng tại Thủy Mộc Trà!</h1>
	<p>Thủy Mộc Trà rất vui thông báo đơn hàng #<?php echo e($order->id); ?> của quý khách đã được tiếp nhận và đang trong quá trình xử lý. Thủy Mộc Trà sẽ thông báo đến quý khách ngay khi hàng chuẩn bị được giao.</p>
	<table>
	<tr>
		<td>
			...
			<table border="0" cellpadding="0" cellspacing="0" style="background:#f5f5f5" width="100%">
				...
				<tbody bgcolor="#eee" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px">										
					<?php $__currentLoopData = $cartInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						<td align="left" style="padding:3px 9px">
							<span class="m_7889669101929006590name"><?php echo e($item->name); ?></span><br>
						</td>
						<td align="left" style="padding:3px 9px"><span><?php echo e(number_format($item->price, 0, 0, '.')); ?> ₫</span></td>
						<td align="left" style="padding:3px 9px"><?php echo e($item->qty); ?></td>
						<td align="right" style="padding:3px 9px"><span><?php echo e(number_format($item->subtotal, 0, 0, '.')); ?> ₫</span></td>
					</tr>
				...
				<tfoot style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px">
					<tr bgcolor="#eee">
						...
						<td align="right" style="padding:7px 9px"><strong><big><span><?php echo e($total); ?> ₫</span> </big> </strong></td>
					</tr>
				</tfoot>
			</table>
		</td>

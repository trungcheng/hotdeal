...
<body>
    ...
    <div class="social-button">
        <div class="social-button-content" style="display:none">
            <a href="tel:<?php echo e($setting->phone); ?>" class="call-icon" rel="nofollow">
                <i class="fa fa-phone" aria-hidden="true"></i>
                <div class="animated alo-circle"></div>
                <div class="animated alo-circle-fill"></div>
                <span>Hotline: <?php echo e($setting->phone); ?></span>
            </a>
            <a href="sms:<?php echo e($setting->phone); ?>" class="sms">
            ...
            <a href="http://zalo.me/<?php echo e($setting->phone); ?>" class="zalo" rel="nofollow">

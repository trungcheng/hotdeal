        ...
        <div class="clearfix">
            ...
            <ul class="menu-mobile">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="">
                        <a title="<?php echo e($cate->name); ?>" href="<?php echo e(route('product-detail', ['slug' => $cate->slug])); ?>"><?php echo e($cate->name); ?></a>
                    </li>
                ...
                <li class="">
                    <a href="<?php echo e(route('store')); ?>" title="Cửa hàng">Cửa hàng</a>
                </li>

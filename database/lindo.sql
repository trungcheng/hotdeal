...
CREATE TABLE `data_services`  (
  ...
  `package_service_id` int(11) NULL DEFAULT NULL,
  ...
  `domain_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `duration` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `price` decimal(15, 4) NULL DEFAULT NULL,
  `vat_price` decimal(15, 4) NULL DEFAULT NULL,
  `total_price` decimal(15, 4) NULL DEFAULT NULL,
  `paid_price` decimal(15, 4) NULL DEFAULT NULL,
  `date_actived` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `histories`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `data_service_id` int(11) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `roles` VALUES (4, 'Subuser', 'Khách lẻ', 0);
...
CREATE TABLE `setting`  (
  ...
  `time_work` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `fb_pixel_code` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
-- Records of setting
-- ----------------------------
INSERT INTO `setting` VALUES (1, NULL, 'Lindo', 'Giải pháp thiết kế website bán hàng chuẩn SEO tốt nhất', ' Tầng 8 số 35, Lương Định Của, Phường Phương Mai, Quận Đống Đa, Hà Nội', '0925.370.999', 'info@lindo.vn', '8:00 AM -17:30 PM', NULL, '', '', '', '2020-03-18 12:51:56', '2020-03-18 12:51:56');

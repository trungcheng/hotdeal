...
@section('page')Cập nhật album ảnh
@stop
                    ...
                    <div class="box-body">
                        <form id="formProcess" onsubmit="return false;" method="POST" enctype="multipart/form-data">
                                            ...
                                            @foreach(explode(',', $article['photos']) as $photo) 
                                                ...
                                                <p class="item-img add_<?php echo $i; ?>" style="margin:3px 0; height: 40px; padding:0;">
                                                    <span style="display:block;">
                                                        <input type="text" value="{{ $photo }}" size="48" name="photos[]" class="form-control list-img" id="xFilePath<?php echo $i; ?>" />
                            ...
                            <div class="modal-footer">
                                <button ng-click="processPhoto('update')" type="button" class="btn btn-primary">Cập nhật</button>

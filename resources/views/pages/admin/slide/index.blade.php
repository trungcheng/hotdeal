    ...
    <div ng-controller="SlideController" ng-init="loadInit()">
        ...
        <section class="content-header" style="padding-top:30px;">
            <h1>
                ...
                <a href="{{ route('slide-create') }}" class="pull-right btn btn-success btn-sm">Thêm slide</a>
            </h1>
        </section>
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="overflow-x:auto;">
                                        <table id="example1" class="table table-bordered table-hover table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody ng-cloak>
                                                <tr role="row" class="@{{ ($odd) ? 'odd' : 'even' }}" ng-repeat="slide in slides track by $index">
                                        ...
                                        <div ng-cloak ng-if="!loading && slides.length === 0">
                                            <h5 style="font-size:16px;color:#f00;">Oops! Không tìm thấy slide!</h5>
                                        </div>
                                    </div>
                                </div>

                                <div class="row" ng-cloak ng-if="!loading && slides.length > 0">

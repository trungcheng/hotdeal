...
@section('page')Trang chương trình khuyến mãi
@stop
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form id="form_setting" onsubmit="return false;" action="{{ url('/admin/access/page/update') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="content">{!! $info->saleoff !!}</textarea>
                    </div>
...
@section('pageJs')
    <script type="text/javascript">
        ...
        $('#form_setting').on('submit', function () {
            ...
            formData.append('saleoff', CKEDITOR.instances.content.document.getBody().getHtml());
            $.ajax({

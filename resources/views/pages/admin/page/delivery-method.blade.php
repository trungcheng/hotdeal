...
@section('page')Trang phương thức vận chuyển
@stop
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form id="form_setting" onsubmit="return false;" action="{{ url('/admin/access/page/update') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="content">{!! $info->delivery_method !!}</textarea>
                    </div>
...
@section('pageJs')
    <script type="text/javascript">
        ...
        $('#form_setting').on('submit', function () {
            ...
            formData.append('delivery_method', CKEDITOR.instances.content.document.getBody().getHtml());
            $.ajax({

...
@section('page')Trang chứng nhận chất lượng
@stop
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <form id="form_setting" onsubmit="return false;" action="{{ url('/admin/access/page/update') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="content">{!! $info->certificate !!}</textarea>
                    </div>
...
@section('pageJs')
    <script type="text/javascript">
        ...
        $('#form_setting').on('submit', function () {
            ...
            formData.append('certificate', CKEDITOR.instances.content.document.getBody().getHtml());

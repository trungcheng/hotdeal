        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">{{ ($authAdminUser->fullname != '') ? $authAdminUser->fullname : $authAdminUser->username }}</h3>
              ...
              <div class="tab-pane active" id="setting">
                <form method="POST" enctype="multipart/form-data" class="form-horizontal" action="{{ route('profile') }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input value="{{ $user->fullname }}" type="text" name="fullname" class="form-control" placeholder="Họ tên">
                    </div>
                  </div>
                  <div class="form-group">

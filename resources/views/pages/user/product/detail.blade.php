      ...
      <div class="row">
        ...
        <div class="col-md-12">
                     ...
                     <div class="col-xs-5">
                        <article class="slider-item on-nav">
                            <div id="slider" class="flexslider">
                                <ul class="slides">
                                  <li>
                                    <img src="{{ asset('frontend/images/item-img-1-1.jpg') }}" alt="">
                                </li>
                                <li>
                                    <img src="{{ asset('frontend/images/item-img-1-2.jpg') }}" alt="">
                                </li>
                                <li>
                                    <img src="{{ asset('frontend/images/item-img-1-3.jpg') }}" alt="">
                                </li>
                                <li>
                                    <img src="{{ asset('frontend/images/item-img-1-1.jpg') }}" alt="">
                                </li>
            ...
            <div class="col-xs-7">
                ...
                <div class="row">
                   <div class="col-sm-6"><span class="price">480.000 VNĐ </span></div>
                   <div class="col-sm-6">
       ...
       <a href="#." class="btn-round"><i class="icon-basket-loaded margin-right-5"></i> Đặt mua ngay</a> 
   </div>
</div>
</div>
<!-- Details Tab Section-->
...
<section class="padding-top-30 padding-bottom-0">
  ...
  <div class="item-slide-4 with-nav">
    ...
    <div class="product">
     <article>
        <img class="img-responsive" src="{{ asset('frontend/images/item-img-1-2.jpg') }}" alt="" > <span class="sale-tag">-25%</span> 
        <!-- Content --> 
        <span class="tag">Tablets</span> <a href="#." class="tittle">Mp3 Sumergible Deportivo Slim Con 8GB</a> 
        <!-- Reviews -->
        <!-- <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p> -->
        <div class="price">350.000 VNĐ<span>$200.00</span></div>
        <!-- <a href="#." class="cart-btn"><i class="icon-basket-loaded"></i></a>  -->
    </article>
</div>
<!-- Product -->
...
<div class="product">
 <article>
    <img class="img-responsive" src="{{ asset('frontend/images/item-img-1-4.jpg') }}" alt="" > <span class="new-tag">New</span> 
    <!-- Content --> 
...
<div class="product">
 <article>
    <img class="img-responsive" src="{{ asset('frontend/images/item-img-1-6.jpg') }}" alt="" > <span class="sale-tag">-25%</span> 
    <!-- Content --> 
    <span class="tag">Tablets</span> <a href="#." class="tittle">Mp3 Sumergible Deportivo Slim Con 8GB</a> 
    <!-- Reviews -->
    <!-- <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p> -->
...
<div class="product">
 <article>
    <img class="img-responsive" src="{{ asset('frontend/images/item-img-1-8.jpg') }}" alt="" > <span class="new-tag">New</span> 
    <!-- Content --> 
    <span class="tag">Accessories</span> <a href="#." class="tittle">Teclado Inalambrico Bluetooth Con Air Mouse</a> 
    <!-- Reviews -->
    <!-- <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p> -->

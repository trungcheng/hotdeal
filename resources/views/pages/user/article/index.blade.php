                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6 col-100">
                            <article class="blog-item">
                                <div class="blog-item-thumbnail">
                                    <a href="{{ route('article-detail', ['slug' => 'cach-lam-banh-bong-lan-cuc-de-bang-noi-com-dien']) }}">
                                ...
                                <h3 class="blog-item-name"><a href="{{ route('article-detail', ['slug' => 'cach-lam-banh-bong-lan-cuc-de-bang-noi-com-dien']) }}" title="Cách làm bánh bông lan cực dễ bằng nồi cơm điện">Cách làm bánh bông lan cực dễ bằng nồi cơm điện</a></h3>
                                <div class="post-time">

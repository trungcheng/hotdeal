        ...
        <div class="row">
            <div class="container-site">
                    ...
                    <div class="box-social-network">
                        <div class="body-network">
                            <ul class="body-social">
                                <li><a target="_blank" href="{{ $setting->facebook_url }}" class="facebook" rel="nofollow"><span>Facebook</span></a></li>
                                <li><a target="_blank" href="{{ $setting->twitter_url }}" class="tweet" rel="nofollow"><span>Tweet</span></a></li>
                                <li><a target="_blank" href="{{ $setting->youtube_url }}" class="youtube" rel="nofollow"><span>Youtube</span></a></li>
                                <li><a target="_blank" href="{{ $setting->google_url }}" class="googleplus" rel="nofollow"><span>Google+</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <div class="banner">
                        <a class="link-logo" href="/" title="Logo Thủy Mộc Trà" target="_self">
                            <img class="img-logo" src="{{ asset('frontend/images/logos/logo.png') }}" width="286" height="131" alt="Logo Thủy Mộc Trà" />
                        </a>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 hidden-sm hidden-xs" style="padding:0">
                ...
                <div class="menu-top-cart">
                    <a href="{{ route('cart') }}" class="nav-mobile-icon" title="Xem giỏ hàng">

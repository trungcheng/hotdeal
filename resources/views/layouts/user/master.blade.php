...
<body>
        ...
        <div class="page-main">
                ...
                <div class="swiper swiper-pagination-inside">
                    <div class="swiper-container" data-plugin="swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" style="background-image:url(images/ex/home/banner/slider-1.jpg)">
                                <div class="container d-flex justify-content-md-end justify-content-center">
                                    <div class="align-self-center text-center text-md-right">
                                        <a href="#">
                                            <img class="img-fluid" src="images/ex/brands/seamaster.png" alt="" width="188">
                                        </a>
            ...
            <section class="section py-0">
                <div class="container">
                    ...
                    <div class="brands row gutter-1 gutter-md-2 gutter-lg-3 mb-5">
                        <div class="col">
                            <a class="brands-item" href="#">
                                <img class="img-fluid" src="images/ex/brands/casio.png" alt="">
                            </a>
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 col-lg-4 d-flex mb-4">
                            <img class="img-fluid w-100 align-self-baseline align-self-md-auto" src="images/ex/omega.jpg" alt="">
                        </div>
                        <div class="col-md-6 col-lg-4 d-flex mb-4">
                            <div class="card card-product">
                                <a class="thumbnail mb-4" href="#">
            ...
            <section class="section section-newsletter section-background text-white mb-0" style="background-image:url(images/bg-newsletter.jpg)">
                <div class="container">
    ...
    <script src="js/photoswipe-init.min.js"></script>
